...
const translations = {
  fr: {
    ...
    sources_indexer_collection_help: "À chaque synchronisation : lecture des capacités, puis récupération paginée jusqu’au maximum configuré. Les catégories Films et Séries définissent les contenus collectés ; chaque média est ensuite automatiquement classé en Film, Série, Documentaire, Émission TV, Animé, Concert ou Spectacle.",
    sources_name: "Nom",
  ...
  en: {
    ...
    sources_indexer_collection_help: "On every synchronization, capabilities are read and results are fetched page by page up to the configured maximum. Movie and Series categories define what is collected; each media item is then automatically classified as Movie, Series, Documentary, TV Show, Anime, Concert, or Live Show.",
    sources_name: "Name",
  ...
  de: {
    ...
    sources_indexer_collection_help: "Bei jeder Synchronisierung werden die Fähigkeiten gelesen und die Ergebnisse bis zum konfigurierten Maximum seitenweise geladen. Film- und Serienkategorien bestimmen die gesammelten Inhalte; jedes Medium wird danach automatisch als Film, Serie, Dokumentation, TV-Sendung, Anime, Konzert oder Aufführung klassifiziert.",
    sources_name: "Name",
    sources_newznab_url: "API-URL",
